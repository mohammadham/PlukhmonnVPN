...
class HomePageState extends State<HomePage> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    // AdmobHelper.showBannerAds(0);
    // AdmobHelper.showBannerAds(1);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
              ...
              tooltip: 'Plackmoon Free Plus',
              onPressed: () {
                if (_serverModel.serverEntityList.isEmpty) {
                  MessageUtil.toast(context.l10n.dontaccesstoplus);
                } else {
        ...
        body: Column( // Wrap HomeWidget in a Column
          children: [
            // if (AdmobHelper.bannerAds.isNotEmpty) // Check if the ad is loaded
            //   SizedBox(
            //     height: AdmobHelper.bannerAds[0]!.size.height.toDouble(), // Adjust height
            //     width: AdmobHelper.bannerAds[0]!.size.width.toDouble(), // Adjust width
            //     child: AdWidget(ad: AdmobHelper.bannerAds[0]!),
            //   ),
            Expanded( // Make HomeWidget take remaining space
              child: const HomeWidget(),
            ),
            // if (AdmobHelper.bannerAds.isNotEmpty && AdmobHelper.bannerAds.length>1) // Check if the ad is loaded
            //   Align(
            //     alignment: Alignment.bottomCenter,
            //     child: SafeArea(
            //       child: SizedBox(
            //         height: AdmobHelper.bannerAds[1]!.size.height.toDouble(), // Adjust height
            //         width: AdmobHelper.bannerAds[1]!.size.width.toDouble(), // Adjust width
            //         child: AdWidget(ad: AdmobHelper.bannerAds[1]!),
            //       ),
            //     ),
            //   )
          ],
